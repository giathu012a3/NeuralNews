        ...
        <main class="flex-1 ml-64 bg-dashboard-bg dark:bg-background-dark/95 min-h-screen">
            ...
            <div class="p-8 space-y-6">
                <div
                    ...
                    <div> <label class="text-[10px] font-bold text-slate-400 uppercase mb-1 block">Danh
                            mục</label>
                        <select
                    ...
                    <div> <label class="text-[10px] font-bold text-slate-400 uppercase mb-1 block">Trạng
                            thái</label>
                        <select
                            class="text-sm border-slate-200 dark:border-slate-600 dark:bg-slate-900 rounded-lg focus:ring-primary">
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-3"> <input
                            class="rounded border-slate-300 text-primary focus:ring-primary" type="checkbox"
                            id="selectAll" />
                    ...
                    <div class="text-sm text-slate-500"> Đang hiển thị từ <%= startItem %>-<%= endItem %> trên tổng số
                                    ...
                                    <% for (Article a : articles) { String
                                        ...
                                        <tr class="<%= rowClass %>">
                                            ...
                                            <td class="px-6 py-4 text-sm font-medium text-slate-500 dark:text-slate-400">
                                                <%= a.getCategoryName() !=null ? a.getCategoryName() : "N/A" %>
                                            </td>
                                            <td class="px-6 py-4"> <a
                                                    class="text-sm text-primary hover:underline font-medium" href="#">
                                                    <%= a.getAuthorName() !=null ? a.getAuthorName() : "Khuyết danh" %>
                                                </a> </td>
                                            ...
                                            <td class="px-6 py-4 text-right">
                                                <div class="flex justify-end gap-1"> <a
                                                    ...
                                                    <% if ("PENDING".equals(a.getStatus())) { %>
                                                        ...
                                                        <% } else if ("PUBLISHED".equals(a.getStatus())) { %> <button
                                                                type="button"
                                                                ...
                                                                title="Lưu trữ bài"> <span
                                                                    class="material-symbols-outlined text-[20px]">archive</span>
                                                            </button>
                                                            <% } else if ("ARCHIVED".equals(a.getStatus())) { %> <button
                                                                    type="button"
                                                                    onclick="handleModerationAction(event, <%= a.getId() %>, 'approve', this)"
                                                                    class="p-2 text-green-500 hover:bg-green-50 dark:hover:bg-green-900/20 rounded-lg transition-all"
                                                                    title="Khôi phục & Đăng bài"> <span
                    ...
                    <div
                        ...
                        <div class="flex items-center gap-1.5">
                            <% String
                                ...
                                ; if(currentPage <=1) prevClass +="opacity-50 pointer-events-none" ; %> <a
                                    href="?page=<%= currentPage > 1 ? currentPage - 1 : 1 %>" class="<%= prevClass %>">
                                    Trước </a>
                                <% for(int i=1; i<=totalPages; i++) { if(i==currentPage) { %>
                                    <span
                                        ...
                                        <%= i %> </span>
                                    <% } else if(i <=3 || i>= totalPages - 2 || (i >= currentPage - 1 && i <= currentPage + 1)) { %> <a href="?page=<%= i %>"
                                            ...
                                            <%= i %> </a>
                                        <% } else if (i==4 && currentPage> 5) { %> <span
                                                class="px-2 text-slate-400">...</span>
                                            <% } else if (i==totalPages - 3 && currentPage < totalPages - 4) { %> <span
                                                    class="px-2 text-slate-400">...</span>
                                                <% } } %>
                                                    <% String
