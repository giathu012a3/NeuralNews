            ...
            <div class="flex min-h-screen">
                ...
                <main class="flex-1 ml-64 min-h-screen flex flex-col overflow-y-auto">
                    ...
                    <div class="p-8 max-w-5xl">
                        <div class="flex items-center justify-end gap-3 mb-8"> <button
                        ...
                        <div class="space-y-6"> <!-- Profile Section -->
                            <section
                                ...
                                <div class="flex items-center gap-2 mb-8"> <span
                                        class="material-icons text-primary">person</span>
                                    <h3 class="font-bold text-lg text-slate-900 dark:text-white">Profile Information
                                    </h3>
                                </div>
                                    ...
                                    <div class="flex flex-col items-center gap-4">
                                        <div class="relative group">
                                            <div
                                                ...
                                                <span class="material-icons text-sm">photo_camera</span> </button>
                                        </div>
                                        <p class="text-xs text-slate-500 dark:text-slate-400 font-medium">Change Avatar
                                        </p>
                                    </div>
                            ...
                            <section
                                class="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-2xl p-6 md:p-8 shadow-sm">
                                <div class="flex items-center gap-2 mb-8"> <span
                                        class="material-icons text-primary">security</span>
                                    <h3 class="font-bold text-lg text-slate-900 dark:text-white">Security & Password
                                    </h3>
                                </div>
                                <div class="max-w-2xl space-y-6">
                                    <div class="space-y-2"> <label
                                            ...
                                            class="w-full bg-slate-50 dark:bg-slate-900/50 border border-slate-200 dark:border-slate-700 rounded-xl px-4 py-3 text-sm focus:ring-primary focus:border-primary transition-all outline-none"
                                            type="password" placeholder="Enter current password" /> </div>
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <div class="space-y-2"> <label
                                                class="text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider ml-1">New
                                                Password</label> <input
                                                class="w-full bg-slate-50 dark:bg-slate-900/50 border border-slate-200 dark:border-slate-700 rounded-xl px-4 py-3 text-sm focus:ring-primary focus:border-primary transition-all outline-none"
                                                type="password" placeholder="Enter new password" /> </div>
                                        <div class="space-y-2"> <label
                                                class="text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider ml-1">Confirm
                                                New Password</label> <input
                                                class="w-full bg-slate-50 dark:bg-slate-900/50 border border-slate-200 dark:border-slate-700 rounded-xl px-4 py-3 text-sm focus:ring-primary focus:border-primary transition-all outline-none"
                                                type="password" placeholder="Confirm new password" /> </div>
                                    </div>
                                    <div class="pt-4 border-t border-slate-100 dark:border-slate-700"> <button
                                            class="text-primary text-sm font-bold hover:underline flex items-center gap-1">
                                            <span class="material-icons text-sm">lock_reset</span> Enable Two-Factor
                                            Authentication </button> </div>
                                </div>
                            </section>
                            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6"> <!-- Notifications -->
                                <section
                                    ...
                                    <div class="flex items-center gap-2 mb-6"> <span
                                            class="material-icons text-primary">notifications</span>
                                        <h3 class="font-bold text-lg text-slate-900 dark:text-white">Notifications</h3>
                                    </div>
                                    <div class="space-y-4"> <label
                                            ...
                                            <div class="flex flex-col"> <span
                                                    class="text-sm font-bold text-slate-800 dark:text-slate-200">System
                                                    Alerts</span> <span class="text-xs text-slate-500">Critical system
                                                    updates and errors.</span> </div> <input checked=""
                                                class="rounded text-primary focus:ring-primary w-5 h-5 border-slate-300"
                                                type="checkbox" />
                                        </label> <label
                                            class="flex items-center justify-between p-3 rounded-xl hover:bg-slate-50 dark:hover:bg-slate-700/50 transition-colors cursor-pointer border border-transparent hover:border-slate-100 dark:hover:border-slate-700">
                                            <div class="flex flex-col"> <span
                                                    class="text-sm font-bold text-slate-800 dark:text-slate-200">User
                                                    Reports</span> <span class="text-xs text-slate-500">New violation
                                                    reports requiring attention.</span> </div> <input checked=""
                                                class="rounded text-primary focus:ring-primary w-5 h-5 border-slate-300"
                                                type="checkbox" />
                                        </label> <label
                                            class="flex items-center justify-between p-3 rounded-xl hover:bg-slate-50 dark:hover:bg-slate-700/50 transition-colors cursor-pointer border border-transparent hover:border-slate-100 dark:hover:border-slate-700">
                                            <div class="flex flex-col"> <span
                                                    ...
                                                    Applications</span> <span class="text-xs text-slate-500">New
                                                    requests to join as contributor.</span> </div> <input
                                                class="rounded text-primary focus:ring-primary w-5 h-5 border-slate-300"
                                                type="checkbox" />
                                        </label> </div>
                                ...
                                <section
                                    class="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-2xl p-6 shadow-sm">
                                    <div class="flex items-center gap-2 mb-6"> <span
                                            class="material-icons text-primary">settings_display</span>
