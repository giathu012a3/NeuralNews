                ...
                <main class="flex-1 ml-64 flex flex-col min-w-0 bg-dashboard-bg dark:bg-slate-900 overflow-hidden">
                    <header
                        ...
                        <div class="flex items-center gap-4"> <button
                                ...
                                <span class="material-symbols-outlined text-[20px]">auto_fix_high</span> AI Auto-Clean
                            </button>
                            <jsp:include page="components/header_profile.jsp" />
                        </div>
                    </header>
                    <div
                        class="px-8 bg-white dark:bg-slate-800 border-b border-slate-200 dark:border-slate-700 flex gap-8">
                        <a href="${pageContext.request.contextPath}/admin/violation.jsp"
                            ...
                            Comment Reports <span
                                class="bg-primary/10 text-primary px-2 py-0.5 rounded-full text-xs">15</span> </button>
                    </div>
                                            ...
                                            <td class="px-6 py-5">
                                                <div>
                                                    <p
                                                        ...
                                                        "This entire narrative is a total fabrication by the deep
                                                        state..." </p>
                                                    <p class="text-[10px] text-slate-400 mt-1 uppercase font-medium">
                                                        Under Article: Breaking News Coverage #291</p>
                                                </div>
                                            </td>
                                            <td class="px-6 py-5">
                                            ...
                                            <td class="px-6 py-5">
                                                <div>
                                                    <p
                                                        ...
                                                        "You clearly don't understand the basic economics of this
                                                        policy..." </p>
                                                    <p class="text-[10px] text-slate-400 mt-1 uppercase">Under Article:
                                                        Economic Forecast 2025</p>
                                                </div>
                                            </td>
                                            <td class="px-6 py-5">
                                                <div class="flex items-center gap-2"> <span
                        ...
                        <aside
                            ...
                            <div class="p-6 border-b border-slate-100 dark:border-slate-700">
                                <div class="flex items-center justify-between mb-2">
                                    <h3 class="font-bold text-slate-800 dark:text-white">Report Details</h3> <span
                            ...
                            <div class="p-6 space-y-8 flex-1">
                                <section>
                                    ...
                                    <div
                                        ...
                                        <div class="flex items-center gap-2 mb-3"> <img alt="User"
                                            ...
                                            <p class="text-xs font-bold text-slate-800 dark:text-white">Marcus Thorne
                                            </p> <span class="text-[10px] text-slate-400">• 2h ago</span>
                                        </div>
                                        <p
                                            class="text-sm text-slate-600 dark:text-slate-300 leading-relaxed italic border-l-2 border-slate-300 pl-3">
                                            "This entire narrative is a total fabrication by the deep state to distract
                                            from the real issues. They are lying about the data and anyone who believes
                                            this is a sheep. We need to wake up before they control us all." </p>
                                    </div>
                                </section>
                                <section>
                                    <h4 class="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-4">
                                        Violation History</h4>
                                    <div class="space-y-3">
                                        <div class="flex items-center justify-between text-xs"> <span
                                                class="text-slate-600 dark:text-slate-400">Previous Strikes</span> <span
                                                class="font-bold text-red-500">2 / 3</span> </div>
                                        <div
                                            class="w-full bg-slate-100 dark:bg-slate-700 h-1.5 rounded-full overflow-hidden">
                                            <div class="bg-red-500 h-full w-[66%]"></div>
                                        </div>
                                        <ul class="space-y-2 mt-4">
                                            <li class="flex gap-2 text-[11px] text-slate-500"> <span
                                                    class="material-icons text-[14px] text-amber-500">history</span>
                                                <span>Aug 12: Suspended for 24h (Spamming)</span>
                                            </li>
                                            <li class="flex gap-2 text-[11px] text-slate-500"> <span
                                                    class="material-icons text-[14px] text-red-500">history</span>
