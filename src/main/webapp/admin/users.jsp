    ...
    <body class="bg-[#F4F7FE] dark:bg-background-dark font-sans text-slate-800 dark:text-slate-100 overflow-hidden">
        <div class="flex min-h-screen">
            ...
            <main class="flex-1 ml-64 min-h-screen pb-12">
                <header
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <div class="flex items-center gap-4">
                            <div class="relative flex items-center group"> <span
                            ...
                            </div> <button onclick="openAddUserModal()"
                                ...
                                <span class="material-icons text-sm">add</span> Add Member </button>
                            <jsp:include page="components/header_profile.jsp" />
                        </div>
                    </div>
                    <div class="mt-6 flex flex-wrap items-center gap-8">
                        <div class="flex items-center gap-3"> <span
                                class="text-xs font-bold text-slate-400 uppercase tracking-wider">Roles:</span>
                            <div class="bg-slate-200/50 dark:bg-slate-800 p-1 rounded-lg flex">
                                ...
                                <div class="px-4 py-2 text-sm font-medium transition-all cursor-pointer">Journalist
                                </div>
                ...
                <div class="p-8 space-y-8"> <!-- Pending Applications Section -->
                    <div
                        ...
                        <div class="flex items-center justify-between mb-6">
                            <div class="flex items-center gap-3">
                                <div class="p-2 bg-indigo-100 dark:bg-indigo-500/20 rounded-lg"> <span
                                        class="material-icons text-indigo-600 dark:text-indigo-400">how_to_reg</span>
                                </div>
                                <div>
                        ...
                        <div class="grid gap-4 md:grid-cols-2 xl:grid-cols-3"> <!-- Applicant Card -->
                            <div
                                ...
                                <div class="flex items-start gap-4">
                                    <div class="relative"> <img alt="Avatar"
                                    ...
                                    <div class="flex-1 min-w-0">
                                        <h4 class="text-sm font-bold text-slate-900 dark:text-white truncate">New
                                            Journalist Applicant</h4>
                                        <p class="text-xs text-slate-500 truncate mb-1">applicant@example.com</p> <span
                                            class="text-[10px] font-medium px-2 py-0.5 bg-slate-100 dark:bg-slate-700 text-slate-500 rounded-md">Applied:
                                            Just now</span>
                                    </div>
                                </div>
                                <div class="mt-4 flex items-center gap-2"> <button onclick="openModal()"
                                        ...
                                        Review Application </button> <button
                                        ...
                                        <span class="material-icons text-[18px]">close</span> </button> </div>
                            </div>
                        </div>
                    </div>
                    <div
                            ...
                            <table class="w-full text-left">
                                <thead>
                                    <tr
                                        ...
                                        <th class="px-8 py-5 text-xs font-bold text-slate-400 uppercase tracking-wider">
                                            User </th>
                                ...
                                <tbody class="divide-y divide-slate-100 dark:divide-slate-700">
                                    <tr class="hover:bg-slate-50 dark:hover:bg-slate-700/30 transition-colors group">
                                        <td class="px-8 py-4">
                                            <div class="flex items-center gap-3"> <img alt="Avatar"
                                                ...
                                                <p class="text-sm font-semibold text-slate-900 dark:text-white">Admin
                                                    Stark </p>
                                            </div>
                                        </td>
                                        ...
                                        <td class="px-8 py-4 text-right">
                                            <div
                                                ...
                                                <button
                                                    ...
                                                    title="Ban"> <span
                                                        class="material-symbols-outlined text-[18px]">lock</span>
                                                </button> <button
                                    ...
                                    <tr class="hover:bg-slate-50 dark:hover:bg-slate-700/30 transition-colors group">
                                        <td class="px-8 py-4">
                                            <div class="flex items-center gap-3"> <img alt="Avatar"
                                                    class="w-9 h-9 rounded-full"
                                                    src="https://lh3.googleusercontent.com/aida-public/AB6AXuC55r-FPmuWNCA53-kd_rt_KLAl5nu4DaqBh0RTF-cYgZxEV2NQeHrabEkBjRzvbBM1edkuSUHwGCS1yceEeNznZZOq85sva-ol4CGokb4XcEx53GR-20x9tDzWWnWePKd5R6HzkUDzU05zc61reG6O6XMxAy7XAZRvYwgDwl-aEnI8DhDUkThHah3waU1liIDvUr2VmJAZhG4HAlgUO7WdaHRn1LjPLYBdd6LMy_dI-6NG2r2FJHbW_vUttZg4hiMUiM68JCyPGg4u" />
                                                <p class="text-sm font-semibold text-slate-900 dark:text-white">Sam
                                                    Wilson </p>
                                            </div>
                                        </td>
                                        <td class="px-6 py-4 text-sm text-slate-500 dark:text-slate-400">
                                        ...
                                        <td class="px-6 py-4"> <span
                                                ...
                                                <span class="w-1.5 h-1.5 rounded-full bg-red-500"></span> Banned </span>
                                        </td>
                                        <td class="px-8 py-4 text-right">
                                            <div
                                                class="flex justify-end gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                                                <button
                                                    ...
                                                    title="Unban"> <span
                                                        class="material-symbols-outlined text-[18px]">lock_open</span>
                                                </button> <button
                                                    class="p-2 text-slate-400 hover:text-red-500 hover:bg-red-50 rounded-lg transition-all"
                                                    title="Delete"> <span
                                                        class="material-symbols-outlined text-[18px]">delete</span>
                        ...
                        <div
                            ...
                            <div class="flex items-center gap-2"> <button
                                    ...
                                    disabled=""> <span class="material-icons text-sm">chevron_left</span> </button>
                                <button
                                ...
                                <button
                                    ...
                                    <span class="material-icons text-sm">chevron_right</span> </button>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div id="userModal" class="fixed inset-0 z-[100] modal-overlay flex items-center justify-center p-4 hidden">
            ...
            <div
                ...
                <div
                    ...
                    <h2 class="text-xl font-bold text-slate-900 dark:text-white leading-none">Journalist Application
                        Details </h2> <button onclick="closeModal()"
                        class="text-slate-400 hover:text-slate-600 dark:hover:text-slate-200 transition-colors"> <span
                            class="material-icons">close</span> </button>
                </div>
                <div class="px-8 py-8 overflow-y-auto">
                    <div class="flex flex-col md:flex-row gap-8">
                        <div class="flex flex-col items-center text-center space-y-4 md:w-1/3">
                            <div class="relative"> <img alt="Julian Casablancas"
                            ...
                            </div> <a class="flex items-center gap-2 text-primary font-semibold text-sm hover:underline"
                                href="#"> <span class="material-icons text-[18px]">download</span> Download CV </a>
                        </div>
                        <div class="flex-1 space-y-6">
                            <div>
                                <h4 class="text-xs font-bold text-slate-400 uppercase tracking-widest mb-2">Professional
                                    Bio </h4>
                                <p class="text-sm text-slate-600 dark:text-slate-300 leading-relaxed"> Experienced
                                    journalist with over 8 years in the field, specializing in tech culture and emerging
                                    AI trends. Previously contributed to several major digital publications and focused
                                    on how technology reshapes urban environments. </p>
                            </div>
                            ...
                            <div>
                                <h4 class="text-xs font-bold text-slate-400 uppercase tracking-widest mb-3">Recent
                                    Writing Samples</h4>
                                <div class="space-y-2"> <a
                                        class="flex items-center justify-between p-3 bg-slate-50 dark:bg-slate-800/50 rounded-xl hover:bg-slate-100 dark:hover:bg-slate-800 transition-all border border-slate-100 dark:border-slate-700"
                                        href="#"> <span
                                            class="text-sm font-medium text-slate-700 dark:text-slate-200">The Future of
                                            Generative AI in Newsrooms</span> <span
                                            class="material-icons text-slate-400 text-sm">open_in_new</span> </a> <a
                                        class="flex items-center justify-between p-3 bg-slate-50 dark:bg-slate-800/50 rounded-xl hover:bg-slate-100 dark:hover:bg-slate-800 transition-all border border-slate-100 dark:border-slate-700"
                                        href="#"> <span
                                            class="text-sm font-medium text-slate-700 dark:text-slate-200">How Algorithm
                                            Bias Affects Public Opinion</span> <span
                                            class="material-icons text-slate-400 text-sm">open_in_new</span> </a> <a
                                        class="flex items-center justify-between p-3 bg-slate-50 dark:bg-slate-800/50 rounded-xl hover:bg-slate-100 dark:hover:bg-slate-800 transition-all border border-slate-100 dark:border-slate-700"
                                        href="#"> <span
                                            class="text-sm font-medium text-slate-700 dark:text-slate-200">Decentralized
                                            Media: A New Era?</span> <span
                                            class="material-icons text-slate-400 text-sm">open_in_new</span> </a> </div>
                            </div>
                        </div>
                    </div>
                </div>
                <div
                    ...
                    <button onclick="approveUser()"
                        ...
                        <span class="material-icons">check_circle</span> Approve Journalist </button> <button
                        onclick="closeModal()"
                        ...
                        <span class="material-icons">cancel</span> Reject Application </button>
                </div>
            </div>
        </div> <!-- Add User Modal -->
        <div id="addUserModal" class="fixed inset-0 z-[100] modal-overlay flex items-center justify-center p-4 hidden">
            ...
            <div
                ...
                <div
                    ...
                    <h2 class="text-lg font-bold text-slate-900 dark:text-white">Add New Member</h2> <button
                ...
                <div
                    ...
                    <button onclick="closeAddUserModal()"
                        ...
                        Cancel </button> <button onclick="createNewUser()"
                        ...
                        <span class="material-icons text-sm">person_add</span> Create Account </button>
                </div>
            </div>
        </div>
        <script>         // Existing modal functions         function openModal() {             document.getElementById('userModal').classList.remove('hidden');         }          function closeModal() {             document.getElementById('userModal').classList.add('hidden');         }          function approveUser() {             alert('Journalist Approved! Access granted to the publishing dashboard.');             closeModal();         }          // New Add User functions         function openAddUserModal() {             document.getElementById('addUserModal').classList.remove('hidden');         }          function closeAddUserModal() {             document.getElementById('addUserModal').classList.add('hidden');         }          function createNewUser() {             // Here you would typically gather form data and send it to the backend via AJAX/Fetch             // For now, we simulate success             const role = document.querySelector('#addUserModal select').value;             alert(`New ${role.charAt(0).toUpperCase() + role.slice(1)} account created successfully!`);             closeAddUserModal();         }     </script>
    </body>
