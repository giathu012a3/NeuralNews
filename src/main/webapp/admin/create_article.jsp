                ...
                <main
                    ...
                    <header
                        ...
                        <div class="flex items-center gap-6"> <a
                                class="flex items-center gap-2 text-slate-400 hover:text-primary transition-colors group"
                                href="${pageContext.request.contextPath}/admin/content.jsp"> <span
                                    class="material-icons text-xl transition-transform group-hover:-translate-x-1">arrow_back</span>
                                <span class="text-sm font-semibold uppercase tracking-wider">Back to Content</span> </a>
                            <div class="h-6 w-px bg-slate-200 dark:bg-slate-700"></div>
                            <div class="flex items-center gap-2"> <span
                                    class="w-2 h-2 bg-emerald-500 rounded-full animate-pulse"></span> <span
                                    class="text-[11px] font-medium text-slate-500 uppercase tracking-widest">Draft
                                    saved: 10:45 AM</span> </div>
                        </div>
                        <div class="flex items-center gap-3"> <button
                                ...
                                <span class="material-icons text-[18px]">visibility</span> Preview </button> <button
                    ...
                    <div class="flex-1 overflow-y-auto editor-container p-8 lg:p-12">
                        <div class="max-w-4xl mx-auto space-y-10">
                            <div class="space-y-6"> <input
                                ...
                                <div
                                    class="flex items-center gap-6 py-4 border-y border-slate-100 dark:border-slate-700">
                                    <div class="flex items-center gap-3"> <img alt="Admin User"
                                        ...
                                        <div class="flex flex-col"> <span
                                                class="text-xs font-bold text-slate-700 dark:text-slate-300">Admin
                                                Console</span> <span
                                                class="text-[10px] text-slate-500 uppercase tracking-tighter">System
                                    ...
                                    <div class="flex items-center gap-4"> <span
                                        ...
                                        <div class="flex items-center gap-1.5 text-slate-500"> <span
                                                class="material-icons text-sm">schedule</span> <span
                                                class="text-[11px] font-medium">5 MIN READ</span> </div>
                                    </div>
                                </div>
                            </div> <!-- Content Area Made Editable -->
                            <div class="prose prose-slate dark:prose-invert max-w-none focus:outline-none min-h-[500px]"
                                contenteditable="true">
                                <p class="text-xl leading-[1.8] text-slate-600 dark:text-slate-300 font-light"> The
                                    integration of artificial intelligence into the newsroom is no longer a distant
                                    possibility—it is an active reality that is reshaping how stories are discovered,
                                    verified, and delivered to audiences worldwide. From automated data analysis to
                                    real-time translation and transcription, AI is providing journalists with powerful
                                    tools to enhance their reporting. </p>
                                <div class="my-10 group relative rounded-2xl overflow-hidden border border-slate-200 dark:border-slate-700"
                                    contenteditable="false"> <img alt="AI Technology Visualization"
                                    ...
                                    <div class="absolute bottom-4 left-6 pointer-events-none">
                                        <p class="text-xs text-white/80 italic">Figure 1: Neural processing
                                            visualization for semantic analysis.</p>
                                    </div>
                                </div>
                                <p class="text-xl leading-[1.8] text-slate-600 dark:text-slate-300 font-light"> However,
                                    as we embrace these advancements, the industry faces critical questions regarding
                                    ethics, bias, and the essential human element of storytelling. How do we ensure that
                                    AI remains a tool for augmentation rather than a replacement for investigative rigor
                                    and journalistic integrity? </p>
                                <div class="mt-12 p-6 border-l-4 border-primary/40 bg-primary/5 rounded-r-xl"
                                    contenteditable="false">
                                    <p class="text-xl leading-relaxed text-slate-400 italic"> Start writing your next
                                        paragraph here or use the 'Ask Copilot' tool for a breakthrough... </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div
                        ...
                        <div class="flex items-center gap-0.5 border-r border-slate-200 dark:border-slate-700 pr-2">
                            <button
                                ...
                                onclick="document.execCommand('bold')"> <span
                                    class="material-icons text-[20px]">format_bold</span> </button> <button
                                class="p-2 hover:bg-slate-100 dark:hover:bg-slate-700 rounded-lg text-slate-600 dark:text-slate-300 transition-colors"
                                onclick="document.execCommand('italic')"> <span
                                    class="material-icons text-[20px]">format_italic</span> </button> <button
                                class="p-2 hover:bg-slate-100 dark:hover:bg-slate-700 rounded-lg text-slate-600 dark:text-slate-300 transition-colors"
                                onclick="document.execCommand('underline')"> <span
                                    class="material-icons text-[20px]">format_underlined</span> </button>
                        </div>
                        <div class="flex items-center gap-0.5 border-r border-slate-200 dark:border-slate-700 pr-2">
                            <button
                                class="p-2 hover:bg-slate-100 dark:hover:bg-slate-700 rounded-lg text-slate-600 dark:text-slate-300 transition-colors"
                                onclick="document.execCommand('insertUnorderedList')"> <span
                                    class="material-icons text-[20px]">format_list_bulleted</span> </button> <button
                                class="p-2 hover:bg-slate-100 dark:hover:bg-slate-700 rounded-lg text-slate-600 dark:text-slate-300 transition-colors">
                                <span class="material-icons text-[20px]">link</span> </button> <button
                                class="p-2 hover:bg-slate-100 dark:hover:bg-slate-700 rounded-lg text-slate-600 dark:text-slate-300 transition-colors">
                                <span class="material-icons text-[20px]">image</span> </button>
                        </div> <button
                            ...
                            <span class="material-icons text-[18px]">auto_awesome</span> Ask Copilot </button>
                    </div>
                </main> <!-- Right Sidebar - AI Tools -->
                <aside
                    ...
                    <div class="p-5 border-b border-slate-200 dark:border-slate-700 flex items-center justify-between">
                        <div class="flex items-center gap-2"> <span
                                class="material-icons text-primary text-[20px]">auto_fix_high</span>
                            <h2 class="text-sm font-bold tracking-tight text-slate-800 dark:text-white">AI COPILOT</h2>
                        </div> <button class="text-slate-400 hover:text-slate-600 transition-colors"> <span
                                class="material-icons text-[20px]">close</span> </button>
                    </div>
                    <div class="flex-1 py-6 px-4 space-y-8">
                        <section>
                            <div class="flex items-center justify-between mb-4 px-1">
                                <h3 class="text-[11px] font-bold uppercase tracking-[0.1em] text-slate-500">Spellcheck
                                    &amp; Grammar</h3> <span class="ai-badge bg-rose-500/10 text-rose-500">3
                                    Issues</span>
                            </div>
                            <div class="space-y-3">
                                <div
                                    ...
                                    <p class="text-xs font-medium mb-3 text-slate-800 dark:text-slate-200">"...future of
                                        <span class="border-b border-rose-500 text-rose-500">tecnology</span>..."
                                    </p>
                        ...
                        <section>
                            <div class="flex items-center justify-between mb-4 px-1">
                                <h3 class="text-[11px] font-bold uppercase tracking-[0.1em] text-slate-500">SEO
                                    Optimizer </h3> <span class="ai-badge bg-emerald-500/10 text-emerald-500">Score:
                                    84</span>
                            </div>
                            <div class="space-y-4 px-1">
                                <div>
                                    <div class="flex items-center justify-between text-[11px] mb-2"> <span
                                            class="text-slate-400">Keyword Density</span> <span
                                            class="text-emerald-500 font-bold uppercase">Optimal</span> </div>
                                    <div
                                ...
                                <div
                                    ...
                                    <div class="flex items-center gap-2 mb-1"> <span
                                            class="material-icons text-primary text-[16px]">lightbulb</span>
                                        <p class="text-[11px] text-slate-400">Recommendation</p>
                                    </div>
                                    <p class="text-xs leading-relaxed text-slate-600 dark:text-slate-300">Add
                                        "Artificial Intelligence" to the first 100 words for better ranking.</p>
                                </div>
                            </div>
                        </section>
                        <section>
                            <div class="flex items-center justify-between mb-4 px-1">
                                <h3 class="text-[11px] font-bold uppercase tracking-[0.1em] text-slate-500">Tone
                                    Analyzer </h3> <span class="ai-badge bg-primary/10 text-primary">Balanced</span>
                            </div>
                    ...
                    <div class="p-4 border-t border-slate-200 dark:border-slate-700 mt-auto"> <button
                            ...
                            <span class="material-icons text-[18px]">settings_suggest</span> Copilot Config </button>
                    </div>
                </aside>
            </div>
        </body>
