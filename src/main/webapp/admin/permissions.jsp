                        ...
                        <div
                            ...
                            <div
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-slate-500">Define what each role can do within the system.
                                    </p>
                                </div>
                                <div class="flex gap-3"> <button
                                        ...
                                        <span class="material-icons text-sm">save</span> Save Changes </button> </div>
                            </div>
                            <div class="overflow-x-auto">
                                <table class="w-full text-left border-collapse">
                                        ...
                                        <tr
                                            ...
                                            <th class="px-6 py-4 text-center min-w-[120px]">
                                                <div class="flex flex-col items-center gap-1"> <span
                                                    ...
                                                    <span class="text-[10px] text-slate-400 font-normal">Full
                                                        Access</span>
                                                </div>
                                            </th>
                                            <th class="px-6 py-4 text-center min-w-[120px]">
                                    ...
                                    <tbody class="divide-y divide-slate-100 dark:divide-slate-700">
                                        ...
                                        <tr class="hover:bg-slate-50 dark:hover:bg-slate-700/30 transition-colors">
                                            <td class="px-6 py-4">
                                                <p class="text-sm font-medium text-slate-700 dark:text-slate-200">View
                                                    Content</p>
                                                <p class="text-xs text-slate-400">Can view published articles and
                                                    comments </p>
                                            </td>
                                        ...
                                        <tr class="hover:bg-slate-50 dark:hover:bg-slate-700/30 transition-colors">
                                            <td class="px-6 py-4">
                                                <p class="text-sm font-medium text-slate-700 dark:text-slate-200">
                                                    Publish Content</p>
                                                <p class="text-xs text-slate-400">Can publish articles without approval
                                                </p>
                                            </td>
                                            <td class="px-6 py-4 text-center"><input type="checkbox" checked
                                                    class="w-5 h-5 rounded border-slate-300 text-primary focus:ring-primary">
                                        ...
                                        <tr class="hover:bg-slate-50 dark:hover:bg-slate-700/30 transition-colors">
                                            <td class="px-6 py-4">
                                                <p class="text-sm font-medium text-slate-700 dark:text-slate-200">Ban
                                                    Users </p>
                                        ...
                                        <tr class="hover:bg-slate-50 dark:hover:bg-slate-700/30 transition-colors">
                                            <td class="px-6 py-4">
                                                <p class="text-sm font-medium text-slate-700 dark:text-slate-200">Global
                                                    Settings</p>
                                                <p class="text-xs text-slate-400">Configure site-wide settings (AI,
                                                    Layout) </p>
                                            </td>
                                            <td class="px-6 py-4 text-center"><input type="checkbox" checked
                                                    class="w-5 h-5 rounded border-slate-300 text-primary focus:ring-primary">
