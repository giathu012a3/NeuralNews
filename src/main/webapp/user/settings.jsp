            ...
            <main class="flex-1 w-full max-w-[1440px] mx-auto p-4 lg:p-8 flex flex-col lg:flex-row gap-8">
                ...
                <div class="flex-1 flex flex-col gap-8">
                    <div class="flex items-center justify-between">
                        <div>
                            <h1 class="text-2xl font-black text-slate-900 dark:text-white tracking-tight">Cài đặt Tài
                                khoản
                            </h1>
                            <p class="text-sm text-slate-500 dark:text-slate-400">Quản lý thông tin hồ sơ và
                                tùy chọn của bạn.</p>
                        </div>
                        <div class="flex items-center gap-3">
                            <button
                                class="px-4 py-2 text-sm font-bold text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-surface-dark rounded-lg transition-colors">Hủy</button>
                            <button
                                class="px-6 py-2 text-sm font-bold bg-primary text-white rounded-lg hover:bg-primary-dark shadow-lg shadow-primary/20 transition-all">Lưu
                                Thay đổi</button>
                        </div>
                    </div>
                    <div class="space-y-6">
                        <section
                            ...
                            <div class="flex items-center gap-2 mb-8">
                                ...
                                <h3 class="font-bold text-lg text-slate-900 dark:text-white">Thông tin Hồ sơ</h3>
                            </div>
                            <div class="flex flex-col md:flex-row gap-8 items-start">
                                <div class="flex flex-col items-center gap-4">
                                    ...
                                    <p class="text-xs text-slate-500 dark:text-slate-400 font-medium">Thay đổi Ảnh đại
                                        diện</p>
                                </div>
                                <div class="flex-1 grid grid-cols-1 md:grid-cols-2 gap-6 w-full">
                                    <div class="space-y-2">
                                        <label class="text-sm font-bold text-slate-700 dark:text-slate-300 ml-1">Họ và
                                            Tên</label>
                                        <input
                                    ...
                                    <div class="space-y-2">
                                        <label class="text-sm font-bold text-slate-700 dark:text-slate-300 ml-1">Địa chỉ
                                            Email</label>
                                        <input
                                            class="w-full bg-slate-50 dark:bg-background-dark/50 border border-slate-200 dark:border-border-dark rounded-xl px-4 py-3 text-sm focus:ring-primary focus:border-primary transition-all"
                                    ...
                                    <div class="space-y-2">
                                        <label class="text-sm font-bold text-slate-700 dark:text-slate-300 ml-1">Số
                                            Điện thoại</label>
                                        <input
                                            class="w-full bg-slate-50 dark:bg-background-dark/50 border border-slate-200 dark:border-border-dark rounded-xl px-4 py-3 text-sm focus:ring-primary focus:border-primary transition-all"
                                    ...
                                    <div class="space-y-2">
                                        <label class="text-sm font-bold text-slate-700 dark:text-slate-300 ml-1">Giới
                                            thiệu</label>
                                        <textarea
                                            class="w-full bg-slate-50 dark:bg-background-dark/50 border border-slate-200 dark:border-border-dark rounded-xl px-4 py-3 text-sm focus:ring-primary focus:border-primary transition-all"
                                            rows="1">Người đam mê công nghệ và rất thích đọc về chính trị toàn cầu.</textarea>
                                    </div>
                                </div>
                            </div>
                        </section>
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            <section
                                ...
                                <div class="flex items-center gap-2 mb-6">
                                    ...
                                    <h3 class="font-bold text-lg text-slate-900 dark:text-white">Ngôn ngữ &amp; Khu vực
                                    </h3>
                                </div>
                                <div class="space-y-4">
                                    <div class="space-y-2">
                                        <label
                                            class="text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider">Ngôn
                                            ngữ
                                            Hiển thị</label>
                                        <select
                                            class="w-full bg-slate-50 dark:bg-background-dark/50 border border-slate-200 dark:border-border-dark rounded-xl px-4 py-3 text-sm focus:ring-primary focus:border-primary transition-all">
                                            <option selected="">Tiếng Anh (US)</option>
                                    ...
                                    <div class="space-y-2">
                                        <label
                                            class="text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider">Nguồn
                                            cấp
                                            Khu vực</label>
                                        <select
                                            class="w-full bg-slate-50 dark:bg-background-dark/50 border border-slate-200 dark:border-border-dark rounded-xl px-4 py-3 text-sm focus:ring-primary focus:border-primary transition-all">
                                            <option selected="">Bắc Mỹ</option>
                            ...
                            <section
                                ...
                                <div class="flex items-center gap-2 mb-6">
                                    ...
                                    <h3 class="font-bold text-lg text-slate-900 dark:text-white">Đăng ký Email</h3>
                                </div>
                                <div class="space-y-4">
                                    <label
                                        ...
                                        <div class="flex flex-col">
                                            <span class="text-sm font-bold text-slate-800 dark:text-slate-200">Tóm tắt
                                                Hàng ngày</span>
                                            <span class="text-xs text-slate-500">Tin tức hàng đầu do AI tuyển chọn mỗi
                                                sáng.</span>
                                        </div>
                                    ...
                                    <label
                                        class="flex items-center justify-between p-3 rounded-xl hover:bg-slate-50 dark:hover:bg-background-dark/50 transition-colors cursor-pointer border border-transparent hover:border-slate-100 dark:hover:border-border-dark">
                                        <div class="flex flex-col">
                                            <span class="text-sm font-bold text-slate-800 dark:text-slate-200">Công nghệ
                                                Hàng tuần</span>
                                            <span class="text-xs text-slate-500">Tìm hiểu chuyên sâu về các công nghệ
                                                mới nổi.</span>
                                        </div>
                                        <input checked="" class="rounded text-primary focus:ring-primary size-5"
                                            type="checkbox" />
                                    ...
                                    <label
                                        class="flex items-center justify-between p-3 rounded-xl hover:bg-slate-50 dark:hover:bg-background-dark/50 transition-colors cursor-pointer border border-transparent hover:border-slate-100 dark:hover:border-border-dark">
                                        <div class="flex flex-col">
                                            <span class="text-sm font-bold text-slate-800 dark:text-slate-200">Cập nhật
                                                Sản phẩm</span>
                                            <span class="text-xs text-slate-500">Tính năng mới và cải tiến cho
                                                nền tảng.</span>
                                        </div>
