    ...
    <div class="max-w-[1440px] mx-auto px-4 lg:px-8 h-16 flex items-center justify-between gap-4">
        ...
        <nav class="hidden lg:flex items-center gap-8">
            <a class="text-sm font-semibold text-slate-600 dark:text-slate-300 hover:text-primary dark:hover:text-primary transition-colors uppercase tracking-wide"
                href="${pageContext.request.contextPath}/user/category.jsp">Politics</a>
            <a class="text-sm font-semibold text-slate-600 dark:text-slate-300 hover:text-primary dark:hover:text-primary transition-colors uppercase tracking-wide"
                href="${pageContext.request.contextPath}/user/category.jsp">Life</a>
            <a class="text-sm font-semibold text-slate-600 dark:text-slate-300 hover:text-primary dark:hover:text-primary transition-colors uppercase tracking-wide"
                href="${pageContext.request.contextPath}/user/category.jsp">Tech</a>
            <a class="text-sm font-semibold text-slate-600 dark:text-slate-300 hover:text-primary dark:hover:text-primary transition-colors uppercase tracking-wide"
                href="${pageContext.request.contextPath}/user/category.jsp">Sports</a>
        </nav>
        <div class="flex items-center gap-4 flex-1 lg:flex-none justify-end">
            <div class="relative hidden md:flex items-center w-full max-w-xs group">
                ...
                <input
                    ...
                    placeholder="Search news with AI..." type="text" />
                    ...
                    <div
                        ...
                        <div
                            ...
                            <% String userAvatarUrl=(String) session.getAttribute("avatarUrl"); String
                                userDisplayName=(String) session.getAttribute("userName"); if (userDisplayName==null)
                                userDisplayName="User" ; if (userAvatarUrl==null || userAvatarUrl.isEmpty()) {
                                userAvatarUrl="https://ui-avatars.com/api/?name=" +
                                java.net.URLEncoder.encode(userDisplayName, "UTF-8" ) + "&background=0D8ABC&color=fff" ;
                                } %>
                    ...
                    <div
                        ...
                        <div class="p-4 border-b border-slate-100 dark:border-slate-700">
                            <% String userName=(String) session.getAttribute("userName"); String userRole=(String)
                                session.getAttribute("userRole"); if (userName==null) userName="Guest Account" ; if
                                (userRole==null) userRole="Visitor" ; %>
