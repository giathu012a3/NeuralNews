    ...
    <div class="max-w-[1440px] mx-auto grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8">
        <div class="col-span-2 lg:col-span-2">
            ...
            <p class="text-slate-500 dark:text-slate-400 text-sm max-w-xs mb-6">
                Bridging the gap between human journalism and artificial intelligence. Trusted news for the
                digital age.
            </p>
        ...
        <div>
            <h4 class="font-bold text-slate-900 dark:text-white mb-4">Categories</h4>
            <ul class="flex flex-col gap-2 text-sm text-slate-600 dark:text-slate-400">
                <li><a class="hover:text-primary transition-colors" href="#">Politics</a></li>
                <li><a class="hover:text-primary transition-colors" href="#">Life &amp; Culture</a></li>
                <li><a class="hover:text-primary transition-colors" href="#">Technology</a></li>
                <li><a class="hover:text-primary transition-colors" href="#">Sports</a></li>
            </ul>
        </div>
        <div>
            <h4 class="font-bold text-slate-900 dark:text-white mb-4">Company</h4>
            <ul class="flex flex-col gap-2 text-sm text-slate-600 dark:text-slate-400">
                <li><a class="hover:text-primary transition-colors" href="#">About NexusAI</a></li>
                <li><a class="hover:text-primary transition-colors" href="#">Careers</a></li>
                <li><a class="hover:text-primary transition-colors" href="#">Editorial Team</a></li>
        ...
        <div>
            ...
            <ul class="flex flex-col gap-2 text-sm text-slate-600 dark:text-slate-400">
                ...
                <li><a class="hover:text-primary transition-colors" href="#">Sitemap</a></li>
            </ul>
        </div>
    </div>
    <div
        ...
        <p>© 2024 NexusAI News. All rights reserved.</p>
        <div class="flex gap-4 mt-2 md:mt-0">
            <a class="hover:text-slate-600 dark:hover:text-slate-200" href="#">Privacy</a>
            <a class="hover:text-slate-600 dark:hover:text-slate-200" href="#">Terms</a>
