...
<head>
    ...
    <title>AI Editor - Unified Journalist Portal</title>
        ...
        <aside
            ...
            <div class="p-5 border-b border-slate-200 dark:border-border-dark flex items-center justify-between">
                <div class="flex items-center gap-3">
                    ...
                    <h2 class="text-sm font-bold tracking-tight">AI COPILOT</h2>
                </div>
            ...
            <div class="flex-1 overflow-y-auto py-6 px-4 space-y-8">
                    ...
                    <div class="space-y-3">
                        <div
                            ...
                            <div class="flex gap-2">
                                ...
                                <button
                                    class="text-[10px] text-slate-400 hover:text-slate-200 px-2 py-1 transition-colors">IGNORE</button>
                            </div>
                        </div>
                    </div>
                </section>
                <section>
                    <div class="flex items-center justify-between mb-4 px-1">
                        <h3 class="text-[11px] font-bold uppercase tracking-[0.1em] text-slate-500">SEO Optimizer</h3>
                    ...
                    <div class="space-y-4 px-1">
                        ...
                        <div
                            ...
                            <p class="text-xs leading-relaxed">Add "Artificial Intelligence" to the first 100 words.</p>
                        </div>
                    </div>
                </section>
                <section>
                    <div class="flex items-center justify-between mb-4 px-1">
                        <h3 class="text-[11px] font-bold uppercase tracking-[0.1em] text-slate-500">Tone Analyzer</h3>
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        ...
                        <div
                            ...
                            <span class="text-[9px] text-slate-500 uppercase font-bold tracking-tighter">Urgent</span>
                        </div>
                    </div>
                </section>
            </div>
            ...
            <header
                ...
                <div class="flex items-center gap-6">
                    <a class="flex items-center gap-2 text-slate-400 hover:text-white transition-colors group"
                        ...
                        <span class="text-sm font-semibold uppercase tracking-wider">Back to Dashboard</span>
                    </a>
                ...
                <div class="max-w-4xl mx-auto space-y-10">
                        ...
                        <div class="flex items-center gap-6 py-4 border-y border-slate-200 dark:border-border-dark">
                            <div class="flex items-center gap-3">
                                ...
                                <div class="flex flex-col">
                                    ...
                                    <span class="text-[10px] text-slate-500 uppercase tracking-tighter">Senior Tech
                                        Editor</span>
                                </div>
                            </div>
                    ...
                    <div class="prose prose-slate dark:prose-invert max-w-none">
                        <p class="text-xl leading-[1.8] text-slate-600 dark:text-slate-300 font-light">
                            ...
                            possibility—it is an active reality that is reshaping how stories are discovered, verified,
                            and delivered to audiences worldwide. From automated data analysis to real-time translation
                        ...
                        <div class="my-10 group relative rounded-2xl overflow-hidden border border-border-dark">
                            ...
                            <div class="absolute bottom-4 left-6">
                                <p class="text-xs text-slate-400 italic">Figure 1: Neural processing visualization for
                                    semantic analysis.</p>
                            </div>
                        </div>
                        <p class="text-xl leading-[1.8] text-slate-600 dark:text-slate-300 font-light">
                            However, as we embrace these advancements, the industry faces critical questions regarding
