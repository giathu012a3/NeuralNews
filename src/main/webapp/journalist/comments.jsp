                ...
                <header
                    ...
                    <div class="flex items-center gap-6">
                        ...
                        <div class="hidden md:flex items-center gap-2 text-xs text-slate-500 font-medium"> <span>Cổng
                                ...
                                class="text-slate-900 dark:text-slate-200">Kiểm duyệt</span> </div>
                    </div>
                    ...
                    <div class="p-8 max-w-5xl mx-auto space-y-6">
                        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-2">
                            ...
                            <div class="flex items-center gap-2"> <button
                                    ...
                                    <span class="material-symbols-outlined text-sm">filter_list</span> Sort: Mới nhất
                                </button> <button
                        ...
                        <div class="grid gap-4">
                            <div
                                ...
                                <div class="p-5">
                                            ...
                                            <div class="min-w-0">
                                                <div class="flex items-center flex-wrap gap-x-2">
                                                    <h5 class="text-sm font-bold text-slate-900 dark:text-white">Julian
                                                        Sterling</h5> <span
                                                        class="text-[11px] text-slate-400 font-medium tracking-tight">2
                                                        giờ trước</span>
                                                </div>
                                                <div
                                    ...
                                    <p
                                        class="text-slate-600 dark:text-slate-300 text-sm leading-relaxed mb-5 pl-[52px]">
                                        Đây là một phân tích tuyệt vời về cách các mô hình ngôn ngữ lớn đang hỗ trợ quy
                                        trình làm việc của nhà báo chưa không phải là thay thế họ. Phần về "kiểm tra
                                        tính xác thực tự động" đặc biệt đáng giá. Làm tốt lắm, Alex! </p>
                                    <div
                                ...
                                <div class="p-5">
                                    <div class="flex justify-between items-start gap-4 mb-4">
                                        <div class="flex items-start gap-3">
                                            ...
                                            <div class="min-w-0">
                                                <div class="flex items-center flex-wrap gap-x-2">
                                                    <h5 class="text-sm font-bold text-slate-900 dark:text-white">Marcus
                                                        Kane </h5> <span
                                                        class="text-[11px] text-slate-400 font-medium tracking-tight">5
                                                        giờ trước</span>
                                                </div>
                                                <div
                                                    class="flex items-center gap-1.5 text-xs text-primary font-semibold mt-0.5 truncate">
                                    ...
                                    <p
                                        ...
                                        khả thi về mặt thương mại. Hầu hết các chuyên gia cho rằng chúng ta vẫn còn
                                        10-15 năm nữa, nhưng bạn ngụ ý rằng nó là một mối đe dọa trực tiếp đối với RSA
                                        hiện tại. </p>
                                    <div
                                        class="flex items-center justify-between pt-4 border-t border-slate-100 dark:border-border-dark pl-[52px]">
                                        <div class="flex items-center gap-4"> <button
                                ...
                                <div class="p-5">
                                    <div class="flex justify-between items-start gap-4 mb-4">
                                        <div class="flex items-start gap-3">
                                            ...
                                            <div class="min-w-0">
                                                <div class="flex items-center flex-wrap gap-x-2">
                                                    <h5 class="text-sm font-bold text-slate-900 dark:text-white">Elena
                                                        Lopez </h5> <span
                                                        class="text-[11px] text-slate-400 font-medium tracking-tight">1
                                                        ngày trước</span>
                                                </div>
                                                <div
                                                    class="flex items-center gap-1.5 text-xs text-primary font-semibold mt-0.5 truncate">
                                    ...
                                    <p
                                        class="text-slate-600 dark:text-slate-300 text-sm leading-relaxed mb-5 pl-[52px]">
                                        Sẽ có một bài viết tiếp theo tập trung cụ thể vào các tòa soạn tin tức địa
                                        phương chứ? Họ có ngân sách ít hơn nhiều cho các loại công cụ này. </p>
                                    <div
                                        class="flex items-center justify-between pt-4 border-t border-slate-100 dark:border-border-dark pl-[52px]">
                                        <div class="flex items-center gap-4"> <button
                                                class="flex items-center gap-1.5 text-slate-500 hover:text-primary transition-colors text-[11px] font-bold uppercase tracking-wider">
                                ...
                                <div class="p-5">
                                    <div class="flex justify-between items-start gap-4 mb-4">
                                        ...
                                        <div
                                            ...
                                            <span class="size-1.5 rounded-full bg-red-500"></span> Spam
                                        </div>
                                    </div>
                                    <p
                                        class="text-slate-500 dark:text-slate-400 text-sm leading-relaxed mb-5 pl-[52px] italic">
                                        "Khám phá mã thông báo tiền điện tử mới của chúng tôi để kiếm tiền trong khi đọc
                                        tin tức! Nhấn vào đây: http://bit.ly/spam-link-example" </p>
                                    <div
                                        class="flex items-center justify-between pt-4 border-t border-slate-100 dark:border-border-dark pl-[52px]">
                                        <div class="flex items-center gap-4"> <button
                        ...
                        <div
                            ...
                            <p class="text-xs font-medium text-slate-500 dark:text-slate-400"> Hiển thị <span
                                    class="text-slate-900 dark:text-white">1-10</span> trong số 482 bình luận </p>
