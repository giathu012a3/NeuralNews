                ...
                <div class="p-8 space-y-8 max-w-[1400px] mx-auto">
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                        <div
                            ...
                            <p class="text-xs font-semibold text-slate-500 uppercase tracking-wider mb-1">Tổng lượt xem
                                Trang</p>
                        ...
                        <div
                            class="bg-white dark:bg-slate-900 p-5 rounded-xl border border-slate-200 dark:border-border-dark shadow-sm">
                            <p class="text-xs font-semibold text-slate-500 uppercase tracking-wider mb-1">Thời gian Đọc
                                Trung bình
                            </p>
                            <div class="flex items-end justify-between">
                        ...
                        <div
                            class="bg-white dark:bg-slate-900 p-5 rounded-xl border border-slate-200 dark:border-border-dark shadow-sm">
                            <p class="text-xs font-semibold text-slate-500 uppercase tracking-wider mb-1">Lượt Tương tác
                            </p>
                            <div class="flex items-end justify-between">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-12 gap-6">
                        <div
                            ...
                            <div class="flex items-center justify-between mb-8">
                                <div>
                                    ...
                                    <p class="text-xs text-slate-500 mt-0.5">Phân bổ cảm xúc người đọc trên tất cả bài
                                        viết</p>
                                </div>
                            ...
                            <div class="relative flex justify-center mb-8">
                                <div
                                    ...
                                    <div class="text-center">
                                        <p class="text-[10px] font-bold text-slate-400 uppercase leading-none">Tổng</p>
                            ...
                            <div class="space-y-3">
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <span class="text-xs font-medium text-slate-600 dark:text-slate-400">Tìm kiếm
                                            Trực tiếp</span>
                                    </div>
                                ...
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <span class="text-xs font-medium text-slate-600 dark:text-slate-400">Mạng Xã
                                            hội</span>
                                    </div>
                        ...
                        <div
                            ...
                            <div class="flex items-center justify-between mb-8">
                                <div>
                                    <h4 class="font-bold text-slate-900 dark:text-white">Đặc điểm Nhân khẩu học Độc giả
                                        Toàn cầu
                                    </h4>
                                    <p class="text-xs text-slate-500 mt-0.5">Bản đồ nhiệt về mức độ tập trung khán giả
                                        theo khu vực
                                    </p>
                                </div>
                    ...
                    <div
                        ...
                        <table class="w-full text-left text-sm">
                            ...
                            <tbody class="divide-y divide-slate-100 dark:divide-slate-800">
                                ...
                                <tr>
                                    <td class="px-6 py-4 font-semibold">An ninh mạng trong Kỷ nguyên Lượng tử...</td>
                                ...
                                <tr>
                                    <td class="px-6 py-4 font-semibold">Giải thích Khủng hoảng Chuỗi cung ứng Toàn cầu
                                    </td>
