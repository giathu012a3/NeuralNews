<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    <aside
        class="w-64 bg-white dark:bg-slate-900 border-r border-slate-200 dark:border-border-dark flex flex-col shrink-0">
        <div class="p-6">
            <div class="flex items-center gap-3 mb-8">
                <a href="${pageContext.request.contextPath}/user/home.jsp" class="flex items-center gap-3 group">
                    ...
                    <div>
                        <h1
                            class="text-sm font-bold leading-tight uppercase tracking-wider text-slate-900 dark:text-white">
                            Phòng tin tức</h1>
        ...
        <div class="mt-auto p-4 border-t border-slate-200 dark:border-border-dark bg-slate-50/50 dark:bg-slate-900/50">
            <div class="flex items-center gap-3">
                ...
                <div class="flex-1 min-w-0">
                    ...
                    <p class="text-[10px] text-slate-500 truncate">Biên tập viên cao cấp</p>
                </div>
