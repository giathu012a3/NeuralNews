...
<head>
    ...
    <title>Journalist Performance Dashboard - NexusAI</title>
</head>
        ...
        <main class="flex-1 flex flex-col min-w-0">
            <header
                ...
                <div class="flex items-center gap-6">
                    <h2 class="text-lg font-bold tracking-tight">Journalist Dashboard</h2>
                    <div class="hidden md:flex items-center gap-2 text-xs text-slate-500 font-medium">
                        <span>Journalist Portal</span>
                        <span class="material-symbols-outlined text-sm">chevron_right</span>
                        <span class="text-slate-900 dark:text-slate-200">Performance Summary</span>
                    </div>
                </div>
                ...
                <div class="p-8 max-w-7xl mx-auto space-y-8">
                    ...
                    <div
                        ...
                        <div class="flex items-center justify-between mb-8">
                            <div>
                                <h4 class="text-base font-bold">View Trends</h4>
                                <p class="text-xs text-slate-500">Traffic performance across the last 30 days</p>
                            </div>
                            <div class="flex bg-slate-100 dark:bg-slate-800 p-1 rounded-lg">
                                <button
                                    class="px-3 py-1 text-[11px] font-bold rounded-md bg-white dark:bg-slate-700 shadow-sm">Daily</button>
                                <button class="px-3 py-1 text-[11px] font-bold text-slate-500">Weekly</button>
                            </div>
                        </div>
                    ...
                    <div class="space-y-4">
                        <div class="flex items-center justify-between">
                            <h4 class="text-base font-bold">Top Performing Articles</h4>
                            <button
                                onclick="window.location.href='${pageContext.request.contextPath}/journalist/articles.jsp'"
                                class="text-xs font-semibold text-primary hover:underline">View All Articles</button>
                        </div>
                        <div
                                    ...
                                    <tr class="hover:bg-slate-50 dark:hover:bg-slate-800/30 transition-colors">
                                        <td class="px-6 py-4">
                                            <div class="flex items-center gap-3">
                                                ...
                                                <div>
                                                    <p class="text-xs font-bold truncate max-w-[240px]">The Future of AI
                                                        in Modern News Reporting</p>
                                                    <p class="text-[10px] text-slate-400">Published 2 days ago</p>
                                                </div>
                                            </div>
                                        </td>
                                    ...
                                    <tr class="hover:bg-slate-50 dark:hover:bg-slate-800/30 transition-colors">
                                        <td class="px-6 py-4">
                                            <div class="flex items-center gap-3">
                                                ...
                                                <div>
                                                    <p class="text-xs font-bold truncate max-w-[240px]">Cybersecurity in
                                                        the Age of Quantum Computing</p>
                                                    <p class="text-[10px] text-slate-400">Published 5 days ago</p>
                                                </div>
                                            </div>
                                        </td>
                                    ...
                                    <tr class="hover:bg-slate-50 dark:hover:bg-slate-800/30 transition-colors">
                                        <td class="px-6 py-4">
                                            <div class="flex items-center gap-3">
                                                ...
                                                <div>
                                                    <p class="text-xs font-bold truncate max-w-[240px]">Why Local
                                                        Newsrooms are Failing to Scale</p>
                                                    <p class="text-[10px] text-slate-400">Published 1 week ago</p>
                                                </div>
                                            </div>
                                        </td>
