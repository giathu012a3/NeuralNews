...
--
-- Host: 127.0.0.1    Database: neural_news
-- ------------------------------------------------------
...
CREATE TABLE `articles` (
  ...
  `status` enum('DRAFT','PUBLISHED','ARCHIVED','REJECTED') COLLATE utf8mb4_unicode_ci DEFAULT 'DRAFT',
  `views` int DEFAULT '0',
  `likes_count` int DEFAULT '0',
  `sentiment_label` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `comments` (
  ...
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `status` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT 'NEUTRAL',
  `parent_id` bigint DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `article_id` (`article_id`),
  KEY `user_id` (`user_id`),
  KEY `comments_ibfk_4` (`parent_id`),
...
INSERT INTO `comments` VALUES (1,'Bài viết rất hay! AI đang thay đổi mọi thứ quá nhanh.',1,2,'2025-03-01 01:30:00','NEUTRAL',NULL),(2,'Thông tin bổ ích, cảm ơn tác giả đã chia sẻ.',1,3,'2025-03-01 02:15:00','NEUTRAL',NULL),(3,'Tôi không đồng ý, cần thêm bằng chứng cụ thể hơn.',1,4,'2025-03-01 03:00:00','NEUTRAL',NULL),(4,'Công nghệ y tế đang tiến bộ vượt bậc, rất kỳ vọng!',2,3,'2025-03-02 01:00:00','NEUTRAL',NULL),(5,'Mình đã áp dụng thử và thấy hiệu quả thật sự.',2,4,'2025-03-02 02:30:00','NEUTRAL',NULL),(6,'Bài viết có nhiều lỗi thực tế, cần xem xét lại.',2,5,'2025-03-02 04:00:00','NEUTRAL',NULL),(7,'UI Động và responsive là tương lai của web!',2,2,'2025-03-03 00:30:00','NEUTRAL',NULL),(8,'Nội dung spam! Click vào đây: http://bit.ly/spam-link',2,4,'2025-03-03 01:45:00','NEUTRAL',NULL),(9,'Rất hữu ích cho công việc thiết kế của tôi.',2,5,'2025-03-03 03:00:00','NEUTRAL',NULL),(10,'Go back to where you came from, nobody wants this.',2,4,'2025-03-04 02:00:00','NEUTRAL',NULL),(11,'I disagree with this stance but respect the reporting.',2,3,'2025-03-04 03:30:00','NEUTRAL',NULL),(12,'Bài phân tích rất chi tiết và dễ hiểu!',2,2,'2025-03-04 05:00:00','NEUTRAL',NULL),(13,'Sự kiện quan trọng, cảm ơn đã cập nhật kịp thời.',2,3,'2025-03-05 01:00:00','NEUTRAL',NULL),(14,'Mong chờ kết quả từ hội nghị này.',2,5,'2025-03-05 02:30:00','NEUTRAL',NULL),(15,'Bài viết mang tính giáo dục cao, nên chia sẻ rộng rãi.',2,2,'2025-03-05 04:00:00','NEUTRAL',NULL),(46,'hihi',2,2,'2026-03-10 06:11:20','NEUTRAL',15);
...
CREATE TABLE `homepage_config` (
  ...
  `layout_type` enum('GRID','LIST','CAROUSEL','HERO') COLLATE utf8mb4_unicode_ci DEFAULT 'GRID',
  `display_columns` int DEFAULT '3',
  `item_limit` int DEFAULT '6',
  `data_source` enum('LATEST','CATEGORY','TRENDING','FEATURED','CUSTOM_HTML') COLLATE utf8mb4_unicode_ci DEFAULT 'LATEST',
  `category_id` int DEFAULT NULL,
...
CREATE TABLE `interactions` (
  ...
  `user_id` bigint NOT NULL,
  `article_id` bigint NOT NULL,
  `type` enum('LIKE','BOOKMARK','VIEW') COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `user_id` (`user_id`),
  KEY `article_id` (`article_id`),
...
CREATE TABLE `reports` (
  ...
  `status` enum('PENDING','Reviewed','DISMISSED','ACTION_TAKEN') COLLATE utf8mb4_unicode_ci DEFAULT 'PENDING',
...
CREATE TABLE `users` (
  ...
  `status` enum('ACTIVE','PENDING','BANNED','SUSPENDED') COLLATE utf8mb4_unicode_ci DEFAULT 'ACTIVE',
...
INSERT INTO `users` VALUES (1,'admin@neuralnews.com','$2a$10$cY1F9jn4o50UT62iLs9PdOBy0UHb8qjlwyhfCY1e1oz3eemWpwctu','Hệ thống Admin',3,'ACTIVE',NULL,'System administrator of NexusAI',10,'2026-03-04 12:16:12'),(2,'tech.writer@neuralnews.com','$2a$10$cY1F9jn4o50UT62iLs9PdOBy0UHb8qjlwyhfCY1e1oz3eemWpwctu','Tech Writer',2,'ACTIVE',NULL,'Senior tech journalist with focus on AI.',5,'2026-03-04 12:16:12'),(3,'health.expert@neuralnews.com','$2a$10$cY1F9jn4o50UT62iLs9PdOBy0UHb8qjlwyhfCY1e1oz3eemWpwctu','Health Expert',1,'ACTIVE',NULL,'Regular user learning about AI',0,'2026-03-04 12:16:12'),(4,'nmt22@gmail.com','$2a$10$yHaOdmaOu7XzxVa0ShXkJuujDnK7OHwYK2J4CrshirmSMD9l2CmqO','asdfghjkl',2,'ACTIVE',NULL,NULL,0,'2026-03-04 13:12:22'),(5,'nmt223@gmail.com','$2a$10$cY1F9jn4o50UT62iLs9PdOBy0UHb8qjlwyhfCY1e1oz3eemWpwctu','asdfghjkl',1,'ACTIVE',NULL,NULL,0,'2026-03-06 13:08:15');
...
-- Dump completed on 2026-03-10 18:43:44
